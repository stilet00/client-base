...
var _a = require('./src/api/firebase/firebaseAdmin'), isAuthenticated = _a.isAuthenticated, adminRules = _a.adminRules;
var connectToDatabase = require('./src/api/database/collections').connectToDatabase;
var _b = require('./src/api/routes/routes'), rootURL = _b.rootURL, clientsURL = _b.clientsURL, translatorsURL = _b.translatorsURL, financeStatementsURL = _b.financeStatementsURL, tasksURL = _b.tasksURL, balanceDayURL = _b.balanceDayURL, personalPenaltiesURL = _b.personalPenaltiesURL;
var _c = require('./src/api/controllers/translatorController'), getLastVirtualGift = _c.getLastVirtualGift, getAllTranslators = _c.getAllTranslators, addNewTranslator = _c.addNewTranslator, updateTranslator = _c.updateTranslator, deleteTranslator = _c.deleteTranslator, sendEmailsToTranslators = _c.sendEmailsToTranslators, assignClientToTranslator = _c.assignClientToTranslator, addPersonalPenaltyToTranslator = _c.addPersonalPenaltyToTranslator, getPersonalPenalties = _c.getPersonalPenalties, toggleSuspendClientResolver = _c.toggleSuspendClientResolver;
var _d = require('./src/api/controllers/taskController'), getAllTasks = _d.getAllTasks, deleteTask = _d.deleteTask, editTask = _d.editTask, createTask = _d.createTask;
var _e = require('./src/api/controllers/statementController'), getAllStatements = _e.getAllStatements, createStatement = _e.createStatement, deleteStatement = _e.deleteStatement;
...
// permision check
app.post(rootURL + 'isAdmin', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var userEmail, admin;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userEmail = request.body.email;
                return [4 /*yield*/, getCollections().collectionAdmins.findOne({
...
app.put(clientsURL + ':id', __spreadArray([], adminRules, true), updateClient);
// translators api
...
app.get(translatorsURL + 'send-emails', __spreadArray([], adminRules, true), sendEmailsToTranslators);
app.post(translatorsURL + 'add', __spreadArray([], adminRules, true), addNewTranslator);
app.put(translatorsURL + 'suspend-client', __spreadArray([], adminRules, true), toggleSuspendClientResolver);
app.put(translatorsURL + 'assign-client', isAuthenticated, assignClientToTranslator);
app.put(translatorsURL + ':id', __spreadArray([], adminRules, true), updateTranslator);
...
app.delete(financeStatementsURL + ':id', __spreadArray([], adminRules, true), deleteStatement);
// balance day api
...
app.get(balanceDayURL + 'translators', isAuthenticated, getBalanceDaysForTranslators);
