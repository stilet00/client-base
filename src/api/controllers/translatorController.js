...
var _a = require('../email-api/financeEmailAPI'), sendEmailTemplateToAdministrators = _a.sendEmailTemplateToAdministrators, sendEmailTemplateToTranslators = _a.sendEmailTemplateToTranslators;
var PersonalPenaltiesSchema = require('../models/translatorsDatabaseModels').PersonalPenaltiesSchema;
var getMomentUTC = require('../utils/utils').getMomentUTC;
var getAllTranslators = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                hasSearchQuery = !!((_a = req.query) === null || _a === void 0 ? void 0 : _a.searchQuery);
                hasShouldGetClients = !!((_b = req.query) === null || _b === void 0 ? void 0 : _b.shouldGetClients);
...
var addNewTranslator = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var sendEmailsToTranslators = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var Translator, startOfPreviousMonth, endOfYesterday, queryForBalanceDays, queryForClients, translators, arrayOfTranslatorNames;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getCollections().collectionTranslators];
            case 1:
                Translator = _a.sent();
                ...
                return [4 /*yield*/, Translator.find({
...
var assignClientToTranslator = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
                _a = req.body, clientId = _a.clientId, translatorId = _a.translatorId;
...
var PersonalPenalties = mongoose_1.default.model('PersonalPenalties', PersonalPenaltiesSchema);
var addPersonalPenaltyToTranslator = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var collections, Translator, _a, translatorId, dateTimeId, amount, description, translator, penalty, error_6;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 4, , 5]);
            ...
            case 1:
                ...
                _a = req.body, translatorId = _a.translator, dateTimeId = _a.dateTimeId, amount = _a.amount, description = _a.description;
            ...
            case 3:
                _b.sent();
                res.status(200).send('Personal penalty successfully added to translator');
                return [3 /*break*/, 5];
            case 4:
                error_6 = _b.sent();
...
var getPersonalPenalties = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, translatorId, dateTimeFilter, collections, Translator, dateTimeFilterMoment, startOfMonth, endOfMonth, selectedTranslator, error_7;
    var _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 3, , 4]);
                _a = req.query, translatorId = _a.translatorId, dateTimeFilter = _a.dateTimeFilter;
                return [4 /*yield*/, getCollections()];
            case 1:
                collections = _c.sent();
                Translator = collections.collectionTranslators;
                ...
                return [4 /*yield*/, Translator.findById(translatorId).populate({
            ...
            case 2:
                ...
                res.send((_b = selectedTranslator === null || selectedTranslator === void 0 ? void 0 : selectedTranslator.personalPenalties) !== null && _b !== void 0 ? _b : []);
                return [3 /*break*/, 4];
            case 3:
                error_7 = _c.sent();
                console.error('An error occurred while getting personal penalties:', error_7);
                res.status(500).send('An error occurred');
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
...
var toggleSuspendClientResolver = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, translatorId, clientId, Client, client, error_8, errorMessage;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 7, , 8]);
                _a = req.body, translatorId = _a.translatorId, clientId = _a.clientId;
                if (!translatorId || !clientId) {
                    return [2 /*return*/, res.status(400).send('Translator or client id is missing')];
                }
            ...
            case 2:
                client = _b.sent();
                if (!client.suspendedTranslators.includes(translatorId)) return [3 /*break*/, 4];
                return [4 /*yield*/, Client.updateOne({ _id: clientId }, { $pull: { suspendedTranslators: translatorId } })];
            case 3:
                _b.sent();
                res.status(200).send('Client unsuspended successfully');
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, Client.updateOne({ _id: clientId }, { $addToSet: { suspendedTranslators: translatorId } })];
            case 5:
                _b.sent();
