				...
				>
					<Fade in={open}>
						<div className={"form-container balance-form gradient-box"}>
							<form>
								<h2 id="transition-modal-title">{name + " " + surname}</h2>
								<div className={"balance-form__date"}>
									...
									/>
									<StyledFormControl variant="outlined" sx={{ margin: 0 }}>
								...
								{!balanceDayIsLoading && !!currentBalanceDayStatistics && (
									<>
										<p>Revenue by Category:</p>
										<div className="balance-form__finances">
											{translatorId !== SUNRISE_AGENCY_ID ? (
												<>
													<div className="balance-form__finances__svadba">
														<div className="balance-form__finances-input">
															<TextField
																...
																value={currentBalanceDayStatistics.chats}
																variant="outlined"
																label={"Chats"}
																type={"number"}
																step="0.01"
														...
														<div className="balance-form__finances-input">
															<TextField
																...
																value={currentBalanceDayStatistics.letters}
																size="small"
																variant="outlined"
																label={"Letters"}
																type={"number"}
														...
														<div className="balance-form__finances-input">
															<TextField
																...
																onChange={handleChange}
																onClick={(e) => e.target.select()}
																value={currentBalanceDayStatistics.penalties}
																size="small"
																variant="outlined"
																label={"Penalties"}
																type={"number"}
													...
													<div className="balance-form__finances__dating">
														<div className="balance-form__finances-input">
															<TextField
																...
																onChange={handleChange}
																onClick={(e) => e.target.select()}
																value={currentBalanceDayStatistics.dating}
																size="small"
																variant="outlined"
																label={"Dating"}
																type={"number"}
														...
														<div className="balance-form__finances-input">
															<TextField
																...
																onChange={handleChange}
																onClick={(e) => e.target.select()}
																value={currentBalanceDayStatistics.phoneCalls}
																size="small"
																variant="outlined"
																label={"Phone calls"}
																type={"number"}
