...
var useWindowDimensions_1 = __importDefault(require("../../../sharedHooks/useWindowDimensions"));
...
var SendEmails = function () {
    var _a = (0, react_1.useState)(false), mailoutInProgress = _a[0], setMailoutInProgress = _a[1];
    var _b = (0, react_1.useState)(defaultMessage), displayMessage = _b[0], setDisplayMessage = _b[1];
    var _c = (0, react_1.useState)(false), isDisabled = _c[0], setIsDisabled = _c[1];
    ...
    var _d = (0, hooks_1.useAlertConfirmation)(), alertStatusConfirmation = _d.alertStatusConfirmation, openAlertConfirmation = _d.openAlertConfirmation, closeAlertConfirmationNoReload = _d.closeAlertConfirmationNoReload;
    var screenIsSmall = (0, useWindowDimensions_1.default)().screenIsSmall;
    var sendNotificationEmails = function () { return __awaiter(void 0, void 0, void 0, function () {
        var res, error_1;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, services_1.sendNotificationEmailsRequest)()];
                case 2:
                    res = _c.sent();
                    if (res.status === 200) {
