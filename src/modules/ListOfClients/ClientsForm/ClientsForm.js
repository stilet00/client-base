...
export default function ClientsForm({
	...
	const site = {
		login: siteFilter === "svadba" ? client.svadba.login : client.dating.login,
		password:
			siteFilter === "svadba" ? client.svadba.password : client.dating.password,
	};
		...
		switch (key) {
			...
			case "bankAccount":
				if (valueIsEmpy) {
					...
					errors[key] = "card number have to be at least 16 characters";
				}
				break;
			case "svadba.login":
				if (valueIsEmpy) {
							...
							<div className="clients-form__body">
								...
								<div className="clients-form__body--big-field media-container">
									<StyledTextField
										...
										onChange={handleChange}
										value={client.instagramLink.replace(regExpForInstagram, "")}
										variant="outlined"
										label={"instagram"}
										required
										InputProps={{
								...
								<StyledTextField
									...
									value={client.bankAccount.replace(regExpForCard, "")}
									variant="outlined"
									label={"card"}
									inputProps={{
										maxLength: 19,
								...
								<StyledTextField
									...
									onChange={handleChange}
									type={siteFilter === "svadba" ? "number" : "email"}
									error={formErrors.login}
									helperText={formErrors.login}
									placeholder={
										siteFilter === "svadba" ? "Numbers only" : "Email like"
									}
									value={site.login}
									variant="outlined"
									label={"Login"}
