...
import {addMonth, changeChartValue, getBalance, removeYear} from "../../services/balanceServices/services";
...
export const useSingleChart = ({ graph, index, deleteGraph, onValueSubmit }) => {
    const data = {
        _id: graph._id,
        labels: graph.days || [],
