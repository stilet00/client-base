...
exports.convertDateToIsoString = exports.getStartOfPreviousDayInUTC = exports.getMomentUTC = exports.saveUserIdTokenToLocalStorage = exports.getNumberWithHundreds = exports.calculatePercentDifference = exports.getClientsRating = exports.getMiddleValueFromArray = exports.getSumFromArray = exports.getStringMonthNumber = exports.calculateTranslatorMonthTotal = exports.getTotalDaysOfMonth = exports.calculateBalanceDaySum = void 0;
...
function getTotalDaysOfMonth(year, monthNumber) {
    ...
    var totalDays = [];
    for (var i = 1; i <= (0, exports.getMomentUTC)(year + '-' + stringMonth, 'YYYY-MM').daysInMonth(); i++) {
        totalDays.push(i);
    }
    return totalDays;
}
exports.getTotalDaysOfMonth = getTotalDaysOfMonth;
var calculateTranslatorMonthTotal = function (balanceDays, forFullMonth, onlySvadba, category) {
    if (forFullMonth === void 0) { forFullMonth = true; }
    if (onlySvadba === void 0) { onlySvadba = false; }
    if (category === void 0) { category = null; }
    var total;
    if (forFullMonth) {
        total = balanceDays === null || balanceDays === void 0 ? void 0 : balanceDays.reduce(function (sum, current) {
            return (sum +
                calculateBalanceDaySum(current.statistics, onlySvadba, category));
        }, 0);
    }
    else {
        var balanceDaysForCurrentPartOFMonth = balanceDays === null || balanceDays === void 0 ? void 0 : balanceDays.filter(function (_a) {
            var dateTimeId = _a.dateTimeId;
            return (0, exports.getMomentUTC)(dateTimeId).isSameOrBefore((0, exports.getMomentUTC)(), 'day');
        });
        total = balanceDaysForCurrentPartOFMonth === null || balanceDaysForCurrentPartOFMonth === void 0 ? void 0 : balanceDaysForCurrentPartOFMonth.reduce(function (sum, current) {
            return (sum +
                calculateBalanceDaySum(current.statistics, onlySvadba, category));
        }, 0);
    }
...
function getSumFromArray(arrayOfNumbers) {
    return arrayOfNumbers.reduce(function (sum, current) { return sum + current; }, 0);
}
...
function getClientsRating(MiddleMonthSum) {
    if (MiddleMonthSum === void 0) { MiddleMonthSum = 0; }
...
function getNumberWithHundreds(number) {
    return Number(number === null || number === void 0 ? void 0 : number.toFixed(2));
}
