...
exports.toggleClientSuspendedRequest =
	...
	exports.getPenaltiesForTranslatorRequest =
	exports.getBalanceDaysForTranslatorRequest =
	exports.updateBalanceDay =
	exports.createBalanceDay =
	exports.getBalanceDay =
	exports.sendLastVirtualGiftDateRequest =
	exports.sendNotificationEmailsRequest =
	exports.assignClientToTranslatorRequest =
	exports.updateTranslator =
	exports.removeTranslator =
...
function getTranslators(_a) {
	var _b = _a.searchQuery,
		...
		_c = _a.shouldGetClients,
		shouldGetClients = _c === void 0 ? false : _c;
	var queryParams = "";
	if (searchQuery) {
		queryParams +=
			(queryParams ? "&" : "?") +
